...
public class TelaComBotoes extends javax.swing.JFrame {
    int posicao = 0;
    List<Roupas> lista; 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaComBotoes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
